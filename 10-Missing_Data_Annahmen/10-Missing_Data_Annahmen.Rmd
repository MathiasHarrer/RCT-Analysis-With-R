...
- Wenn korrekt angewandt führt MI zur **\alert{verzerrungsfreien Schätzung von Populationsparametern}** (Regressionsgewichte, Populationsmittelwerte, Korrelationen, etc.) sowie deren Varianz ("asymptotically unbiased") --- trotz des Vorliegens fehlender Werte.
